...
class Framework {
    ...
    private static function initConst() {
        ...
        define('ROOT_PATH', getcwd() . DS);  //定义入口文件所在的目录
    ...
    private static function initRoutes() {
        ...
        $a = isset($_GET['a']) ? $_GET['a'] : $GLOBALS['config']['app']['da'];
        //数据形式处理
        ...
        define('__URL__', CONTROLLER_PATH . $p . DS);   //当前请求控制器的目录地址,如/Application/Controller/Admin
        define('__VIEW__', VIEW_PATH . $p . DS);     //当前视图的目录地址,如/Application/View/Admin
    }
